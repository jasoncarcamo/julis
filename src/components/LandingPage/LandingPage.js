        ...
        return (
            <section id="landing-page">
                ...
                <section>
                    ...
                    <p>From deep cleaning your kitchen and bathrooms to changing your bed linens, we are dedicated to creating clean, and safe living environments. We are proud to use environmentally-conscious products that are safe for people and pets. </p>
                ...
                <section className="first-section">
                    ...
                    <Link className="request-service" to="/services">Get started</Link>
                </section>
